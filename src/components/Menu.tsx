...
const menuItems = [
  {
    id: 1,
    name: "Ферганский плов",
    description: "Тот самый плов, ради которого стоит встать пораньше. Рис девзира, нежная баранина, морковь соломкой и секретная смесь специй — всё как в лучших чайханах Ферганы.",
    price: "от 450 ₽",
    weight: "400 г",
    image: plov,
    badge: "Хит",
